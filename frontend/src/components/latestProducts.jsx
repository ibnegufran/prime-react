    ...
    <div className="border-1    border-gray-300 m-2 text-center border-bottom-8 py-5 px-3 flex flex-col justify-center items-center gap-4 shadow-md">
        ...
        <div>
            ...
            <div className="mt-5 flex flex-wrap gap-2 justify-content-center">
                <Button className='py-2 px-4 text-[1.5rem] font-200' label='add to cart ' icon="pi pi-cart-arrow-down mx-2 text-[1.2rem]" rounded  onClick={()=>auth.user == null ?   toast.error("please login first", {
        duration: 2000,
        position: 'top-center',
