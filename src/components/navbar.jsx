...
const Navbar = () => {
  ...
  return (
<>
<div className={`z-50 w-[100vw] py-2 px-6 justify-content-between bg-white border-bottom-1 border-300  flex align-items-center md:justify-content-around  ${scrollToggle == true ?" md:fixed md:top-0 md:left-0" :"md:relative"}`} >
    <div className="">
